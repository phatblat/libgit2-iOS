#
# Be sure to run `pod spec lint libgit2-iOS.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/phatblat/libgit2-iOS'
  s.author   = { 'Ben Chatelain' => 'benchatelain@gmail.com' }

  # Specify the location from where the source should be retreived.
  #
  s.source   = { :git => 'https://phatblat@github.com/phatblat/libgit2-iOS.git', :tag => '0.1.0' }

  s.description = 'An optional longer description of libgit2-iOS.'
  ...
  #
  s.source_files = 'Classes', 'libgit2/src/**/*.{h,m}'
